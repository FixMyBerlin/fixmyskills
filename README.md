...
| [agent-orchestration](skills/agent-orchestration/)               | Fable + Composer workers — separate Cursor IDE and Claude Code setup (`init-cursor.sh` / `init-claude.sh`) | `bunx skills add FixMyBerlin/fixmyskills --skill agent-orchestration -a cursor -y`                                       |
