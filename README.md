...
| [react-map-gl](skills/react-map-gl/)                                 | react-map-gl/maplibre — MapProvider, layers, URL viewport, tilda-geo patterns      | `npx skills add FixMyBerlin/fixmyskills --skill react-map-gl -a cursor -y`                                              |
| [rust-wasm-geo](skills/rust-wasm-geo/)                               | Rust/WASM geo — Turf vs WASM, crates, wasm-bindgen, Vite for FMC geo-heavy apps    | `npx skills add FixMyBerlin/fixmyskills --skill rust-wasm-geo -a cursor -y`                                             |
