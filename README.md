...
| [agent-orchestration](skills/agent-orchestration/)               | Fable orchestrator + Composer worker subagents; `scripts/init.sh` copies `.cursor/agents` and rules    | `bunx skills add FixMyBerlin/fixmyskills --skill agent-orchestration -a cursor -y`                                       |
