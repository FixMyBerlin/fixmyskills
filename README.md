...
| [unslop-code](skills/unslop-code/)                                 | Orchestrated cleanup after LLM work: Zod 4, TS, shims, undeployed WIP, location, decision lift, semantic HTML, leftover process, then unslop-text | `bunx skills add FixMyBerlin/fixmyskills --skill unslop-code -a cursor -y`                                               |
