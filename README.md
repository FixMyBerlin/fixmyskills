...
| [cleanup-llm-changes](skills/cleanup-llm-changes/)                 | Orchestrated cleanup after LLM work: Zod 4, TS inference, re-export shims, legacy paths, skill-aligned reviews, unslop              | `bunx skills add FixMyBerlin/fixmyskills --skill cleanup-llm-changes -a cursor -y`                                       |
