...
| [cleanup-llm-changes](skills/cleanup-llm-changes/)                 | Orchestrated cleanup after LLM work — Zod 4, re-export shims, legacy paths, skill-aligned reviews                                   | `bunx skills add FixMyBerlin/fixmyskills --skill cleanup-llm-changes -a cursor -y`                                       |
