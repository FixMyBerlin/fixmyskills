...
| [unslop-code](skills/unslop-code/)                                 | Orchestrated cleanup after LLM work: Zod 4, TS inference, re-export shims, legacy paths, skill-aligned reviews, then unslop-text    | `bunx skills add FixMyBerlin/fixmyskills --skill unslop-code -a cursor -y`                                               |
